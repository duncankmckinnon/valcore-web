...
function Evaluators() {
  return <>
    ...
    <section id="creating"><h2>Creating evaluators</h2><h3>Manual creation</h3><p>Each evaluator runs as an agent judge. Name it, write the judging prompt, choose a model—a Gateway model or a <a href="/docs/configuration#local-models">local CLI</a>—and list every required dataset column. Ask the agent judge to explain its reasoning before returning a score.</p>
